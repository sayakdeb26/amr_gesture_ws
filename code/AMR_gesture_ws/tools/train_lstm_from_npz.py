...
def main():
    ...
    torch.onnx.export(model, dummy, onnx_30, input_names=["x"], output_names=["logits"],
                      dynamic_axes={"x":{0:"batch"}, "logits":{0:"batch"}}, opset_version=17)
    print("Saved", onnx_30)
    ...
    torch.onnx.export(flat, dummy_flat, onnx_2520, input_names=["x"], output_names=["logits"],
                      dynamic_axes={"x":{0:"batch"}, "logits":{0:"batch"}}, opset_version=17)
